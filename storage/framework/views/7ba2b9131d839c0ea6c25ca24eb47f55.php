...
<div class="container py-4">
    <div class="row g-4">
        <div class="col-md-6">
            <a href="<?php echo e(route('admin.violations.status', 'approved')); ?>" class="text-decoration-none">
        ...
        <div class="col-md-6">
            <a href="<?php echo e(route('admin.violations.status', 'pending')); ?>" class="text-decoration-none">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\StudentViolationAndMonitoring_System\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>