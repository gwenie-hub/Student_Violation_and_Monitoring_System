...
<div class="login-bg">
    <div class="login-card mx-auto">
        <div class="d-flex justify-content-center align-items-center mb-3">
            <a href="/">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="login-logo mx-auto d-block">
            </a>
        </div>
        ...
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form" autocomplete="off">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
