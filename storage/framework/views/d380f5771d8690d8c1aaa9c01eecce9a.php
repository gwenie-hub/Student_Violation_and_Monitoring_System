...
<?php $__env->startSection('sidebar'); ?>
    ...
    <aside class="w-64 bg-white shadow-sm p-4 border-end min-vh-100 sidebar">
        ...
        <div class="text-center mb-4">
            <img src="<?php echo e(asset('images/logo2.png')); ?>" alt="Logo" class="h-16 w-16 mx-auto">
        </div>
        ...
        <ul class="nav flex-column text-dark">
            <li class="nav-item mb-1">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link px-3 py-2 <?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard Overview
                </a>
            </li>
            <li class="nav-item mb-1">
                <a href="<?php echo e(route('admin.violations')); ?>" class="nav-link px-3 py-2">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-sm btn-primary me-1 edit-student-btn"
                                ...
                                data-student='<?php echo json_encode($student, 15, 512) ?>'>
                                <i class="bi bi-pencil-square"></i>
                            </button>
                            <form action="<?php echo e(route('admin.students.delete', $student->Student_ID)); ?>" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this student?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\StudentViolationManagementSystem\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>