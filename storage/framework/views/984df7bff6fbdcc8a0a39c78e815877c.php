...
?>
    ...
    <nav class="flex-grow-1 mt-3">
        <ul class="nav flex-column gap-1 fw-medium text-primary">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.users')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-primary hover-bg">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.violations')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-primary hover-bg">
                    <i class="bi bi-exclamation-triangle-fill fs-5 text-primary"></i>
                    <span>Violations</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.roles')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-primary hover-bg">
