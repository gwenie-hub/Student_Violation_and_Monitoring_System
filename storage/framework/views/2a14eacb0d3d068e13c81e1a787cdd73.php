<aside class="w-64 bg-white shadow-lg border-r p-6">
    ...
    <nav class="flex flex-col space-y-2 text-gray-800">
        ...
        <a href="<?php echo e(route('admin.students')); ?>" class="hover:bg-gray-200 px-3 py-2 rounded">Student Records</a>
...
<?php /**PATH C:\xampp\htdocs\Student_Violation_and_Monitoring_System\resources\views/partials/sidebar-admin.blade.php ENDPATH**/ ?>