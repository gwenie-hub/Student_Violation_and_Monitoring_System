...
$__html = app('livewire')->mount($__name, $__params, 'lw-2933096100-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <nav class="flex-grow-1 mt-3">
        <ul class="nav flex-column gap-1 fw-medium text-primary">
            <li class="nav-item">
                <a href="<?php echo e(route('parent.dashboard')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-primary hover-bg">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.settings')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-primary hover-bg">
...
<?php /**PATH C:\laragon\www\StudentViolationManagementSystem\resources\views/partials/sidebar-parent.blade.php ENDPATH**/ ?>