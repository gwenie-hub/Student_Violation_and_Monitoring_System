...
?>
    <nav class="flex-grow-1 mt-3">
        <ul class="nav flex-column gap-1 fw-medium">
            <li class="nav-item">
                <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-dark sidebar-link">
                    <i class="bi bi-house-door-fill fs-5"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('superadmin.add-user')); ?>" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-dark sidebar-link">
