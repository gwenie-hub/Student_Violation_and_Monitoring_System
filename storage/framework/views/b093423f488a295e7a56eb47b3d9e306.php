...
<div class="flex min-h-screen relative">
    ...
    <div class="flex-1">
        ...
        <div class="bg-white p-3 shadow z-50 w-full flex justify-between items-center sticky top-0">
            ...
            <span class="font-semibold text-lg"><?php echo e(config('app.name', 'Laravel')); ?></span>
        </div>
...
<?php /**PATH C:\laragon\www\StudentViolationManagementSystem\resources\views/layouts/app.blade.php ENDPATH**/ ?>