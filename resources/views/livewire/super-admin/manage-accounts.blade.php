            ...
            <tbody id="userTableBody">
                @foreach ($users as $user)
                    <tr data-role="{{ $user->getRoleNames()->first() }}">
                        <td class="border border-gray-200 p-3 text-gray-700">{{ $user->name }}</td>
                        <td class="border border-gray-200 p-3 text-gray-700">{{ $user->email }}</td>
                        <td class="border border-gray-200 p-3 text-gray-700">{{ $user->getRoleNames()->join(', ') }}</td>
