<aside class="w-100 d-flex flex-column bg-white shadow-sm border-end min-vh-100" style="font-family: 'Inter', sans-serif;">
    ...
    <nav class="flex-grow-1 mt-3">
        <ul class="nav flex-column gap-1 fw-medium">
            <li class="nav-item">
                <a href="{{ route('professor.dashboard') }}" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-dark sidebar-link">
                    <i class="bi bi-speedometer2 fs-5"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('professor.violations.my') }}" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-dark sidebar-link">
                    <i class="bi bi-journal-text fs-5"></i>
                    <span>My Violations</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('professor.violations.create') }}" class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 text-decoration-none text-dark sidebar-link">
